# 👋 Hi, I'm Bishal Kumar Nath

🚀 **Full Stack Developer | React | FastAPI | AWS (Learning)**

I’m a passionate developer focused on building scalable web applications with clean architecture and production-ready practices. I enjoy working across the stack — from crafting responsive UIs in React to designing efficient backend APIs with FastAPI.

Currently, I’m strengthening my skills in **cloud deployment (AWS)** and **system design**, aiming to build highly available and scalable applications.
...
### 🎨 FuryEditor (Excalidraw Clone - In Progress 🚧)

A collaborative drawing and diagramming tool inspired by Excalidraw.

**Key Features (Planned & In Progress):**

* ✏️ Real-time drawing canvas
* 🔹 Shape tools (rectangle, arrow, free draw, etc.)
* 🔹 State management for canvas elements
* 🔹 Clean and minimal UI for better UX
* 🔹 Future scope: real-time collaboration
